...
class AkunKeuanganSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $tanah = AkunKeuangan::firstOrCreate(
            ['kode_akun' => '1201'],
            [
                'nama_akun' => 'Tanah',
        ...
        foreach ([
            ['kode_akun' => '1201-1', 'nama_akun' => 'Tanah A', 'parent_id' => $tanah->id, 'kategori_akun_id' => 1, 'is_leaf' => true],
            ['kode_akun' => '1201-2', 'nama_akun' => 'Tanah B', 'parent_id' => $tanah->id, 'kategori_akun_id' => 1, 'is_leaf' => true],
            ['kode_akun' => '1201-3', 'nama_akun' => 'Tanah C', 'parent_id' => $tanah->id, 'kategori_akun_id' => 1, 'is_leaf' => true],
        ] as $item) {
            AkunKeuangan::firstOrCreate(['kode_akun' => $item['kode_akun']], $item);
        }
        ...
        // PENJUALAN RUMAH
        $penjualanRumah = AkunKeuangan::firstOrCreate(
            ['kode_akun' => '4100'],
            [
        ...
        foreach ([
            ['kode_akun' => '4101', 'nama_akun' => 'Penjualan Rumah Cash Keras/Tahap', 'parent_id' => $penjualanRumah->id, 'kategori_akun_id' => 4, 'is_leaf' => true],
            ['kode_akun' => '4102', 'nama_akun' => 'Penjualan Rumah KPR', 'parent_id' => $penjualanRumah->id, 'kategori_akun_id' => 4, 'is_leaf' => true],
            ['kode_akun' => '4103', 'nama_akun' => 'Penambahan Bangunan', 'parent_id' => $penjualanRumah->id, 'kategori_akun_id' => 4, 'is_leaf' => true],
            ['kode_akun' => '4104', 'nama_akun' => 'Kelebihan Tanah', 'parent_id' => $penjualanRumah->id, 'kategori_akun_id' => 4, 'is_leaf' => true],
        ] as $item) {
            AkunKeuangan::firstOrCreate(['kode_akun' => $item['kode_akun']], $item);
        }
        ...
        foreach ([
            ['kode_akun' => '4201', 'nama_akun' => 'Admin Pembatalan', 'parent_id' => $pendapatanLain->id, 'kategori_akun_id' => 4, 'is_leaf' => true],
            ['kode_akun' => '4202', 'nama_akun' => 'Penjualan Tanah Kavling', 'parent_id' => $pendapatanLain->id, 'kategori_akun_id' => 4, 'is_leaf' => true],
            ['kode_akun' => '4203', 'nama_akun' => 'Penjualan Aset Tetap', 'parent_id' => $pendapatanLain->id, 'kategori_akun_id' => 4, 'is_leaf' => true],
            ['kode_akun' => '4204', 'nama_akun' => 'Denda Atas Keterlambatan Bayar', 'parent_id' => $pendapatanLain->id, 'kategori_akun_id' => 4, 'is_leaf' => true],
        ] as $item) {
            AkunKeuangan::firstOrCreate(['kode_akun' => $item['kode_akun']], $item);
        }
        ...
        // 6000 Harga Pokok Penjualan
        $hpp = AkunKeuangan::firstOrCreate(
            ['kode_akun' => '6000'],
            [
