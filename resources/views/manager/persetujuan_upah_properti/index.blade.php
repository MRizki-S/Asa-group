...
@section('pageActive', 'managerPersetujuanUpahProperti')
...
@section('content')
    <div class="mx-auto max-w-[--breakpoint-2xl] p-4 md:p-6" x-data="{
        ...
        confirmAction(type) {
            ...
            if (this.isMultiple) {
                form.action = '{{ route('manager.persetujuanUpahProperti.index') }}/update-status';
                ...
                form.action = `/manager/persetujuan-upah-properti/${this.selectedItem.id}`;
            }
        ...
        <div class="space-y-5 sm:space-y-6">
            <div
                ...
                <div class="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    {{-- Filter Dropdown --}}
                    <form action="{{ route('manager.persetujuanUpahProperti.index') }}" method="GET" id="form-filter">
                        <div class="flex items-center gap-3">
                            <label for="filter"
