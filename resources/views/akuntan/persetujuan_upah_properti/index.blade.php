...
@section('pageActive', 'akuntanPersetujuanUpahProperti')
            ...
            <div
                ...
                <div class="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Halaman verifikasi & konfirmasi persetujuan pengajuan upah borongan oleh Akuntan Keuangan</p>
                    </div>

                    {{-- Filter Dropdown --}}
                    <form action="{{ route('akuntan.persetujuanUpahProperti.index') }}" method="GET" id="form-filter">
                        <div class="flex items-center gap-3">
                            <label for="filter"
