...
@section('pageActive', 'akuntanPersetujuanUpahKawasan')
        ...
        confirmAction(type) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.action = `/akuntan/persetujuan-upah-kawasan/${this.selectedItem.id}`;
        ...
        <div class="space-y-5 sm:space-y-6">
            <div
                ...
                <div class="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    {{-- Filter Dropdown --}}
                    <form action="{{ route('akuntan.persetujuanUpahKawasan.index') }}" method="GET" id="form-filter">
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        ...
                                        @else
                                            <div class="flex flex-col items-center justify-center gap-1">
                                                <div class="flex flex-col items-center justify-center gap-1">
                                                    @if ($item->status_pengajuan === 'ditolak_akuntan')
                                                        <span
