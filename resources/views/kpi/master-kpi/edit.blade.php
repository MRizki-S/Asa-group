            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="flex justify-end gap-3 mt-4">
                    <a href="{{ route('kpi.komponen.index') }}"
                        class="px-6 py-3 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 transition">
                        Batal
                    </a>
                    <button type="submit"
                        class="px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 shadow-lg shadow-blue-600/20 transition">
                        Perbarui Master KPI
                    </button>
                </div>
            </div>
