            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="flex justify-end items-center gap-3 mt-4">
                    ...
                    <button type="submit"
                        ...
                        class="px-10 py-3 text-sm font-bold text-white bg-blue-600 rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-blue-600/20 transition-all uppercase tracking-wide">
                        Simpan & Inisialisasi
                    </button>
                </div>
            </div>
            ...
            return {
                ...
                async fetchData() {
                    ...
                    try {
                        ...
                        // Default: Pilih semua user
                        this.selectedUsers = this.users.map(u => u.id.toString());
                        this.allUsersSelected = true;

                        // Default: Pilih semua komponen & kalkulasi pembagian rata
                ...
                // Fungsi membagi rata bobot secara cerdas
                recalculateWeights() {
                    ...
                    if (count > 0) {
                        ...
                        this.selectedKomponen.forEach((id, index) => {
                            // Sisa pembagian (remainder) diberikan ke baris pertama agar total pas 100
