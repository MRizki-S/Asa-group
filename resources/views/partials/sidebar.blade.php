        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-2 mb-6">
                    ...
                    <!-- Menu Group Item Nota Masuk  -->
                    <li>
                        <a href="#"
                            @click.prevent="selected = (selected === 'NotaMasuk' ? '':'NotaMasuk')"
                            class="menu-item group"
                            :class="(selected === 'NotaMasuk') || (page === 'TambahNotaMasuk' || page === 'DaftarNotaMasuk'|| page === 'proFormLayout') ? 'menu-item-active' :
                                                    'menu-item-inactive'">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                :class="(selected === 'NotaMasuk') ||
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'NotaMasuk') ? 'menu-item-arrow-active' :
                                                            'menu-item-arrow-inactive',
                                                            sidebarToggle ? 'lg:hidden' : ''
                                                        ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden transform translate"
                            :class="(selected === 'NotaMasuk') ? 'block' : 'hidden'">
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col mt-2 menu-dropdown pl-9">
            ...
            @can('akses-produksi')
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-2 mb-6">
                        ...
                        <li>
                            <a href="#" @click.prevent="selected = (selected === 'NotaMasuk' ? '':'NotaMasuk')"
                                class="menu-item group"
                                :class="(selected === 'NotaMasuk') || (page === 'DaftarNotaMasuk' ||
                                                page === 'TambahNotaMasuk') ? 'menu-item-active' :
                                            'menu-item-inactive'">
                                <svg :class="(selected === 'NotaMasuk') && (page === 'NotaMasuk') ?
                                            'menu-item-icon-active' : ''"
                                    class="w-6 h-6 text-gray-800 dark:text-white size-6" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <title>package-receive</title>
