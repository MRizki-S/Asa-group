                ...
                <ul class="flex flex-col gap-4 mb-6">
                    <li>
                        ...
                        <a href="/#" @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                            class="menu-item group" :class="(selected === 'Dashboard') || (page === 'Marketing' ||
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="/dashboard-marketing" class="menu-dropdown-item group" :class="page === 'Dashboard-Marketing' ? 'menu-dropdown-item-active' :
                                ...
                                <li>
                                    <a href="index.html" class="menu-dropdown-item group" :class="page === 'Keuangan' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Keuangan
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="index.html" class="menu-dropdown-item group" :class="page === 'Produksi' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Produksi
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="index.html" class="menu-dropdown-item group" :class="page === 'Gudang' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Gudang
                                    </a>
                                </li>
                ...
                <ul class="flex flex-col gap-2 mb-6">
                    ...
                    <li>
                        <a href="/etalase/perumahaan" @click="selected = (selected === 'Perumahaan' ? '':'Perumahaan')"
                            class="menu-item group" :class="(selected === 'Perumahaan') && (page === 'Perumahaan') ? 'menu-item-active' :
                            'menu-item-inactive'">
                    ...
                    <li>
                        <a href="/etalase/tipe-unit" @click="selected = (selected === 'TipeUnit' ? '':'TipeUnit')"
                            class="menu-item group" :class="(selected === 'TipeUnit') && (page === 'TipeUnit') ? 'menu-item-active' :
                            'menu-item-inactive'">
                            <svg :class="(selected === 'TipeUnit') && (page === 'TipeUnit') ? 'menu-item-icon-active' :
                            'menu-item-icon-inactive'" width="24" height="24" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li>
                        <a href="/etalase/kualifikasi-blok"
                            ...
                            class="menu-item group" :class="(selected === 'KualifikasiBlok') && (page === 'KualifikasiBlok') ? 'menu-item-active' :
                            'menu-item-inactive'">
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'blokUnit' ? '':'blokUnit')"
                            class="menu-item group" :class="(selected === 'blokUnit') || (page === 'blokLayout' || page === 'formLayout' ||
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ route('blok.index') }}" class="menu-dropdown-item group" :class="page === 'blokLayout' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                ...
                                <li>
                                    <a href="{{ route('unit.indexGlobal') }}" class="menu-dropdown-item group" :class="page === 'unitLayout' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                            viewBox="0 0 24 24">
                ...
                <ul class="flex flex-col gap-2 mb-6">
                    ...
                    <li>
                        <a href="/marketing/manage-pemesanan"
                            ...
                            class="menu-item group" :class="(selected === 'ManagePemesanan') && (page === 'ManagePemesanan') ? 'menu-item-active' :
                            'menu-item-inactive'">
                            <svg :class="(selected === 'ManagePemesanan') && (page === 'ManagePemesanan') ?
                            'menu-item-icon-active' :
                            'menu-item-icon-inactive'" width="26" height="26" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Pengajuan' ? '':'Pengajuan')"
                            class="menu-item group" :class="(selected === 'Pengajuan') || (page === 'PengajuanPemesanan' ||
                            ...
                            <svg :class="(selected === 'Pengajuan') || (page === 'PengajuanPemesanan' ||
                                page === 'PengajuanPembatalan' ||
                                page === 'pieChart') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24"
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="/marketing/pengajuan-pemesanan" class="menu-dropdown-item group" :class="page === 'PengajuanPemesanan' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Pengajuan Pemesanan
                                    </a>
                                </li>
                                ...
                                {{-- Pengajuan Pembatalan --}}
                                <li>
                                    <a href="/marketing/pengajuan-pembatalan" class="menu-dropdown-item group" :class="page === 'PengajuanPembatalan' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Pengajuan Pembatalan
                                    </a>
                                </li>
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Adendum' ? '':'Adendum')"
                            class="menu-item group" :class="(selected === 'Adendum') || (page === 'BuatAdendum' ||
                                page === 'ListAdendum') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'Adendum') || (page === 'BuatAdendum' || page === 'ListAdendum') ? 'menu-item-icon-active' :
                                'menu-item-icon'" class="w-5 h-5 flex-shrink-0" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Adendum') || (page === 'BuatAdendum' || page === 'ListAdendum') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive',
                                    sidebarToggle ? 'lg:hidden' : ''
                                ]" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585" stroke="" stroke-width="1.5"
                        ...
                        <!-- Dropdown Menu Start -->
                        <div class="overflow-hidden transform translate"
                            :class="(selected === 'Adendum') || (page === 'BuatAdendum' || page === 'ListAdendum') ? 'block' : 'hidden'">
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                ...
                                <li>
                                    <a href="{{ route('marketing.adendum.index') }}" class="menu-dropdown-item group" :class="page === 'BuatAdendum' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Buat Adendum
                                    </a>
                                </li>
                                ...
                                {{-- List Adendum --}}
                                <li>
                                    <a href="{{ route('marketing.adendum.list') }}" class="menu-dropdown-item group" :class="page === 'ListAdendum' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        List Adendum
                                    </a>
                                </li>
                    ...
                    <li>
                        <a href="/marketing/setting"
                            ...
                            class="menu-item group" :class="(selected === 'SettingPPJB') && (page === 'SettingPPJB') ? 'menu-item-active' :
                                'menu-item-inactive'">
                            <svg :class="(selected === 'SettingPPJB') && (page === 'SettingPPJB') ?
                                'menu-item-icon-active' :
                                ''" width="24" height="24" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="flex flex-col gap-2 mb-6">
                    ...
                    <li>
                        <a href="{{ route('marketing.akunUser.index') }}"
                            ...
                            class="menu-item group" :class="(selected === 'akunKaryawan') && (page === 'akunKaryawan') ? 'menu-item-active' :
                                'menu-item-inactive'">
