        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-2 mb-6">
                    ...
                    <!-- Adendum -->
                    @hasrole(['Super Admin', 'Admin KPR', 'Manager Keuangan'])
                        <li>
                            <a href="/marketing/adendum"
                                @click="selected = (selected === 'Adendum' ? 'Adendum' : 'Adendum')"
                                class="menu-item group"
                                :class="(selected === 'Adendum') && (page === 'Adendum') ? 'menu-item-active' :
                                'menu-item-inactive'">

                                <!-- Icon berkas (file/document) -->
                                <svg :class="(selected === 'Adendum') && (page === 'Adendum') ? 'menu-item-icon-active' :
                                'menu-item-icon'"
