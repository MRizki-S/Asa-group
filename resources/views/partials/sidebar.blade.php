                    ...
                    <ul class="flex flex-col gap-2 mb-6">
                        ...
                        <li>
                            <a href="#" @click.prevent="selected = (selected === 'upahBoronganKeuanganGroup' ? '':'upahBoronganKeuanganGroup')"
                                class="menu-item group"
                                :class="(selected === 'upahBoronganKeuanganGroup') || (page === 'managerPersetujuanUpahProperti' || page === 'managerPersetujuanUpahKontraktor' || page === 'managerPersetujuanUpahKawasan' || page === 'akuntanPersetujuanUpahProperti' || page === 'akuntanPersetujuanUpahKontraktor' || page === 'akuntanPersetujuanUpahKawasan') ? 'menu-item-active' : 'menu-item-inactive'">
                                <svg :class="(selected === 'upahBoronganKeuanganGroup') || (page === 'managerPersetujuanUpahProperti' || page === 'managerPersetujuanUpahKontraktor' || page === 'managerPersetujuanUpahKawasan' || page === 'akuntanPersetujuanUpahProperti' || page === 'akuntanPersetujuanUpahKontraktor' || page === 'akuntanPersetujuanUpahKawasan') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300'"
                                ...
                                <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">Upah Borongan</span>
                                <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                    :class="[(selected === 'upahBoronganKeuanganGroup') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '']"
                ...
                <ul class="flex flex-col gap-2 mb-6">
                    ...
                    <li>
                        <a href="#"
                            ...
                            class="menu-item group"
                            :class="(selected === 'UpahHarianTukangGroup') || (page === 'MasterTukangHarian' || page === 'DaftarPengajuanUpahABM' || page === 'DaftarPengajuanUpahMangoon') ? 'menu-item-active' :
                            'menu-item-inactive'">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                :class="(selected === 'UpahHarianTukangGroup') ||
                                (page === 'MasterTukangHarian' ||
                                    page === 'DaftarPengajuanUpahABM' ||
                                    page === 'DaftarPengajuanUpahMangoon') ?
                                'menu-item-icon-active' :
                                'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="1.5" class="size-6">
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{ route('gudang.pengajuanUpahHarianTukang.index') }}"
                                        class="menu-dropdown-item group flex items-center gap-3"
                                        :class="page === 'DaftarPengajuanUpahABM' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            :class="(selected === 'UpahHarianTukangGroup') ||
                                            (page === 'DaftarPengajuanUpahABM') ?
                                ...
                                <li>
                                    <a href="{{ route('gudang.pengajuanUpahHarianTukang.indexMangoon') }}"
                                        class="menu-dropdown-item group flex items-center gap-3"
                                        :class="page === 'DaftarPengajuanUpahMangoon' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            :class="(selected === 'UpahHarianTukangGroup') ||
                                            (page === 'DaftarPengajuanUpahMangoon') ?
