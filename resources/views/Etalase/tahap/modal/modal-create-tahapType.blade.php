    <div id="modal-create-tahapTypeUnit" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md p-4">
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <!-- Body -->
                <form id="simpleForm" action="{{ route('tahapType.store', ['tahap' => $tahap]) }}" {{-- ganti sesuai route penyimpanan --}}
                    method="POST" class="p-4 space-y-4">
                    @csrf

                    {{-- Type Unit --}}
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-white">Tipe Unit</label>
                        <select name="type_id"
                   ...
                   @error('type_id') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">
                            ...
                            @foreach ($availableTypes as $tipe)
                    ...
                    <div class="flex justify-end gap-3 mt-6">
                        <button type="button" data-modal-toggle="modal-create-tahapTypeUnit"
