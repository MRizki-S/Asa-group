...
@section('pageActive', 'PeriodeKeuangan')
...
@section('content')
    ...
    <div class="mx-auto max-w-[--breakpoint-2xl] p-4 md:p-6">
        ...
        <!-- Breadcrumb Start -->
        <div x-data="{ pageName: 'PeriodeKeuangan' }">
        ...
        <div class="space-y-5 sm:space-y-6">
            <div
                ...
                <table id="table-periodeKeuangan">
                    <thead>
                    ...
                    <tbody>
                        @foreach ($periodeKeuangan as $item)
                            <tr class="text-center">
                                <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $item->nama_periode }}</td>
    ...
    @include('keuangan.periode.modal.modal-create-periode')
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.delete-btn')) {
                ...
                Swal.fire({
                    ...
                    text: "Apakah anda yakin menghapus Periode Keuangan ini?",
                    icon: 'warning',
    ...
    <script>
        if (document.getElementById("table-periodeKeuangan") && typeof simpleDatatables.DataTable !== 'undefined') {
            const dataTable = new simpleDatatables.DataTable("#table-periodeKeuangan", {
                searchable: true,
                sortable: false
            });
        }
