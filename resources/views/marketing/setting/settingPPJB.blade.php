                        ...
                        <div class="flex flex-wrap gap-4 mb-4">
                            ...
                            <div class="flex-1 min-w-[150px]">
                                <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Jumlah
                                    Cicilan</label>
                                <input type="text" readonly value="{{ $caraBayar->jumlah_cicilan ?? '-' }} X"
                            ...
                            <div class="flex-1 min-w-[150px]">
                                ...
                                <input type="text" readonly
                                    value="Rp {{ number_format($caraBayar->minimal_dp ?? 0, 0, ',', '.') }}"
                                    class="bg-gray-50 border text-gray-900 text-sm rounded-lg w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                            </div>
                            ...
                            <div class="flex-1 min-w-[150px]">
                                <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Diajukan
                                    Oleh</label>
                                <input type="text" readonly value="{{ $caraBayar->pengaju->username ?? '-' }}"
                                    class="bg-gray-50 border text-gray-900 text-sm rounded-lg w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                            </div>
                            ...
                            <div class="flex-1 min-w-[150px]">
                                <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Disetujui
                                    Oleh</label>
                                <input type="text" readonly value="{{ $caraBayar->approver->username ?? '-' }}"
                                    class="bg-gray-50 border text-gray-900 text-sm rounded-lg w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                            </div>
                        </div>
            ...
            <div class="px-5 py-4 sm:px-6 sm:py-5">
                ...
                <div class="flex flex-wrap gap-4 mb-4">
                    ...
                    <div class="flex-1 min-w-[150px]">
                        ...
                        <input type="text" readonly value="{{ rtrim(rtrim(number_format($pembatalanPPJB->persentase_potongan, 2, '.', ''), '0'), '.') }} %"
                            class="bg-gray-50 border text-gray-900 text-sm rounded-lg w-full p-2.5
                              focus:ring-blue-500 focus:border-blue-500
                              dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                              dark:focus:ring-blue-500 dark:focus:border-blue-500">
