<div x-data="{
    ...
    <div x-show="caraBayar === 'kpr'" x-transition class="px-5 py-4 sm:px-6 sm:py-5">
        ...
        {{-- <div x-data="{
            ...
            // Getter untuk nilai numeric
            get dpPembeliNumber() {
                return parseInt(this.dpPembeli.replace(/\D/g, '')) || 0;
            },
            get dpRumahIndukNumber() {
                return this.dpPembeliNumber + this.sbumPemerintah;
            },
            get totalDpNumber() {
            ...
            // Getter format tampilan
            get dpRumahInduk() {
                return formatRupiah(this.dpRumahIndukNumber.toString());
            },
            get totalDp() {
            ...
            updateDpPembeli(e) {
                let raw = e.target.value.replace(/\D/g, '');
                this.dpPembeli = formatRupiah(raw);
            },
        ...
        // Inisialisasi awal jika selectedCustomer sudah ada
        if (selectedCustomer?.booking) {
        ...
        dark:bg-yellow-900/30 dark:border-yellow-700 transition-all duration-300 hover:shadow-sm">
            ...
            <div>
                ...
                <input type="text" readonly :value="dpRumahInduk"
            ...
            dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700 cursor-not-allowed"
                ...
                <p class="text-xs text-gray-500 mt-1">
                    Masukan inputan dengan termasuk <b>+ SBUM Pemerintah</b>.
                </p>
            </div>
            ...
            <div>
                <label for="kpr" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                    Dp Dibayarkan Pembeli <span class="text-red-500">*</span>
                </label>
                <input type="text" x-model="dpPembeli" @input="updateDpPembeli"
                    class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5
            dark:bg-gray-700 dark:text-white dark:border-gray-600"
