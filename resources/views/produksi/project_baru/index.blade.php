            ...
            <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <form action="{{ route('produksi.projectBaru.store') }}" method="POST" id="form-create-project">
                    ...
                    <div class="space-y-4">
                        ...
                        <button type="submit" class="w-full inline-flex items-center justify-center px-5 py-2.5 bg-blue-600 text-white text-sm font-bold rounded-lg hover:bg-blue-700 transition shadow-sm text-center">Simpan Project</button>
                    </div>
                </form>
            </div>
        </div>
