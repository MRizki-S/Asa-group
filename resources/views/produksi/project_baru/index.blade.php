            ...
            <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <form action="{{ route('produksi.projectBaru.store') }}" method="POST" id="form-create-project">
                    ...
                    <div class="space-y-4">
                        ...
                        <button type="submit" class="w-full rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Simpan Project</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="lg:col-span-2">
            <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="overflow-x-auto">
                    <table id="table-project-baru" class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <td class="px-6 py-4">{{ $p->tanggal_mulai ? \Carbon\Carbon::parse($p->tanggal_mulai)->format('d M Y') : '-' }}</td>
                                <td class="px-6 py-4">
