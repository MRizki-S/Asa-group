<div x-show="openRequest" class="fixed inset-0 z-[99999] flex items-center justify-center bg-black/50 dark:bg-black/80"
    ...
    <div @click.away="openRequest = false"
        ...
        <div
            ...
            <div class="flex-none flex items-center justify-between p-4 border-b dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
                <h3 class="text-lg font-bold text-gray-900 dark:text-white">Buat Order Barang (<span x-text="filterType"></span>)</h3>
                <button type="button" @click="openRequest = false" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
            ...
            <form @submit.prevent="submitRequest" class="flex-1 flex flex-col min-h-0 overflow-hidden">
                                                    ...
                                                    <div class="grid grid-cols-2 gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <select :value="item.satuan_id"
                                                                ...
                                                                class="w-full p-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg text-sm focus:ring-2 focus:ring-blue-500/20 outline-none">
                                                                <template
                                                    ...
                                                    <template
                                                        ...
                                                        <div class="animate-in fade-in slide-in-from-top-1">
                                                            ...
                                                            <textarea x-model="item.alasan" placeholder="Wajib diisi karena order melebihi jatah RAP..."
                                                                class="w-full p-2 text-[11px] border border-red-200 dark:border-red-800 rounded-lg bg-red-50/50 dark:bg-red-900/20 text-gray-900 dark:text-white outline-none focus:ring-1 focus:ring-red-300"></textarea>
                                                        </div>
                                                    </template>
                                                </div>
                                            </div>
                        ...
                        <div x-show="showAdditional" x-transition class="space-y-3">
                            ...
                            <div class="space-y-3">
                                <template x-for="(extra, eIdx) in itemsAdditional" :key="eIdx">
                                    <div class="p-4 border border-blue-100 dark:border-blue-800 bg-white dark:bg-gray-800 rounded-xl relative shadow-sm">
                ...
                <div class="flex-none p-4 border-t border-gray-100 dark:border-gray-600 bg-gray-50/80 dark:bg-gray-800 space-y-3">

                    <div class="p-2 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-100 dark:border-amber-800">
                        <label
