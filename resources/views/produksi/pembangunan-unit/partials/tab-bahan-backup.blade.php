<div x-show="tab === 'bahan'" class="space-y-4">
    <div class="flex justify-between items-center px-1">
        <h4 class="text-xs font-bold text-gray-700 uppercase tracking-widest">Daftar Bahan RAP</h4>
        ...
        <table class="w-full text-left border-collapse bg-white dark:bg-white/5">
            <thead class="bg-gray-50 dark:bg-gray-800/50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-[10px] font-bold text-gray-500 uppercase text-right">Kebutuhan</th>
                    <th class="px-4 py-2 text-[10px] font-bold text-gray-500 uppercase text-center">Status</th>
                </tr>
            </thead>
                ...
                @forelse($qc->pembangunanUnitRapBahan as $bahan)
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-white/5 transition-colors">
                        <td class="px-4 py-2.5">
                            <p class="text-xs font-bold text-gray-700 dark:text-gray-200">{{ $bahan->nama_barang }}</p>
                        </td>
                        ...
                        <td class="px-4 py-2.5 text-center">
                            <span
                                class="text-[8px] font-black text-blue-600 bg-blue-50 dark:bg-blue-900/30 px-2 py-0.5 rounded uppercase border border-blue-100 dark:border-blue-800">
                                RAP
                            </span>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="3" class="px-4 py-6 text-center text-xs text-gray-500 italic">
                            Belum ada data bahan di RAP ini.
                        </td>
                    </tr>
                @endforelse
            </tbody>
