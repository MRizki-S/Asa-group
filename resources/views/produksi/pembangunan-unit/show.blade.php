...
@section('content')
    <div class="mx-auto max-w-[--breakpoint-2xl] p-4 md:p-6 text-gray-700"
        ...
        @update-total-progress.window="totalProgress = $event.detail" x-data="{
            openRequest: false,
        ...
        <template x-teleport="body">
            <div x-show="openCancelOrderModal"
                class="fixed inset-0 z-[99999] flex items-center justify-center bg-black/50 dark:bg-black/80" x-cloak
                x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
                x-transition:enter-end="opacity-100">
                <div @click.away="openCancelOrderModal = false" class="relative w-full max-w-md p-4">
                    <div
                        class="relative bg-white rounded-xl shadow-xl dark:bg-gray-800 overflow-hidden border border-gray-100 dark:border-gray-700">
                        <div
                            class="flex items-center justify-between p-4 border-b dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
                            ...
                            <form :action="cancelOrderActionUrl" method="POST" class="p-5 space-y-4">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                                    Apakah Anda yakin ingin membatalkan order barang ini? Tindakan ini tidak dapat
                                    dibatalkan.
                                </p>
