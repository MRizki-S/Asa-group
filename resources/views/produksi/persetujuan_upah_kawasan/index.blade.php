...
@section('pageActive', 'persetujuanUpahKawasan')
...
@section('content')
    <div class="mx-auto max-w-[--breakpoint-2xl] p-4 md:p-6" x-data="{
        ...
        confirmAction(type) {
            ...
            form.action = `/produksi/persetujuan-upah-kawasan/${this.selectedItem.id}`;
        ...
        <div class="space-y-5 sm:space-y-6">
            <div
                ...
                <div class="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    {{-- Filter Dropdown --}}
                    <form action="{{ route('produksi.persetujuanUpahKawasan.index') }}" method="GET" id="form-filter">
