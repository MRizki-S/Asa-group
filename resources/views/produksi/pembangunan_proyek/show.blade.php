            ...
            <div class="flex-1 space-y-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div class="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/60 relative" x-data="{ openStatus: false }">
                        ...
                        @can('produksi.kontraktor.pembangunan-proyek.edit-status')
                        <div class="relative">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="relative border-l-2 border-gray-200 dark:border-gray-700 ml-2 space-y-5 pb-2">
                                        ...
                                        <div class="relative pl-6">
                                            ...
                                            @endphp
                                            <div class="absolute -left-[9px] top-1 w-4 h-4 rounded-full border-4 border-white dark:border-gray-900 shadow-sm {{ $textColorAkuntan }}"></div>
    ...
    <div x-show="tab === 'retur'" style="display: none;">
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div class="xl:col-span-1 rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <form action="{{ route('produksi.pembangunanProyek.returnStore') }}" method="POST" x-data="{ submittingRetur: false }" @submit="if(submittingRetur) { $event.preventDefault(); return; }; submittingRetur = true">
                    @csrf
                    <input type="hidden" name="pembangunan_proyek_id" value="{{ $data->id }}">
