    ...
    <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800 mb-6 flex flex-wrap gap-6 justify-between items-center">
        ...
        <div class="flex flex-col gap-4 items-end">
            ...
            <div class="flex flex-wrap gap-2 justify-end">
                <a href="{{ route('produksi.pembangunanKawasan.laporanUpah', $data->id) }}" class="inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-sm transition-all duration-200">
                    <i class="fa-solid fa-money-bill-wave"></i> Laporan Termin Upah
                </a>
                <a href="{{ route('produksi.pembangunanKawasan.laporanBahan', $data->id) }}" class="inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-sm transition-all duration-200">
    ...
    <template x-teleport="body">
        <div x-show="openReturnModal"
            ...
            <div @click.away="openReturnModal = false"
                ...
                <form action="{{ route('produksi.pembangunanKawasan.returnStore') }}" method="POST" class="flex-1 flex flex-col overflow-hidden">
                    @csrf
