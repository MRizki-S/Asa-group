...
@section('content')
    <div class="mx-auto max-w-[--breakpoint-2xl] p-4 md:p-6" x-data="{}">
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h2 class="text-xl font-bold text-gray-800 dark:text-white">Laporan Perbandingan Bahan Proyek</h2>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden shadow-sm">
                <div class="px-6 py-4 bg-gray-50/70 dark:bg-gray-800/60 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between sm:items-center gap-2">
                    <h4 class="text-sm font-bold text-gray-800 dark:text-gray-100 uppercase tracking-wider">
                        Rincian Pemakaian Bahan Proyek
                    </h4>
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border-b border-gray-100 dark:border-gray-700 pb-4 mb-4">
                <div>
                    <h3 class="text-base font-bold text-gray-900 dark:text-white">Ringkasan Biaya Realisasi Bahan Proyek</h3>
                    <p class="text-xs text-gray-500">Total akumulasi biaya realisasi pemakaian bahan proyek</p>
                </div>
            ...
            <div class="space-y-3">
                <div class="pt-2 border-t-2 border-dashed border-gray-200 dark:border-gray-700 flex justify-between items-center text-base font-bold">
                    <span class="text-gray-900 dark:text-white uppercase tracking-wider">Total Biaya Keseluruhan</span>
                    <span class="text-xl font-bold font-mono text-emerald-600 dark:text-emerald-400">Rp {{ number_format($laporan['total_harga_real'] ?? 0, 0, ',', '.') }}</span>
                </div>
            </div>
        </div>
    </div>
