...
@section('content')
                    ...
                    <tbody>
                        ...
                        active:scale-95">
                                    ...
                                    <form action="{{ route('gudang.masterSatuanBarang.destroy', $item->id) }}"
                                        ...
                                        @method('DELETE')
                                        <button type="button"
                                            class="delete-btn px-3 py-1 text-xs text-white bg-red-600 rounded hover:bg-red-700">
                                            Delete
                                        </button>
                                    </form>
                                </td>
    ...
    <script>
        ...
        if (document.getElementById("table-masterSatuan") && typeof simpleDatatables.DataTable !== 'undefined') {
            const dataTable = new simpleDatatables.DataTable("#table-masterSatuan", {
                searchable: true,
                sortable: true,
