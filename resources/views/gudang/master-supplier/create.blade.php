...
@section('content')
    <div class="mx-auto max-w-[--breakpoint-2xl] p-4 md:p-6">
        ...
        <form action="{{ route('gudang.masterSupplier.store') }}" method="POST">
            @csrf
            ...
            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] mb-6">
                <div class="px-5 py-4 sm:px-6 sm:py-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="kode_supplier_preview" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Kode Supplier
                                <span class="ms-1 text-xs font-normal text-gray-400">(otomatis)</span>
                            </label>
                            <input type="text" id="kode_supplier_preview"
                                value="{{ $kodePreview }}" readonly
                            ...
                            <p class="text-xs text-gray-400 mt-1">Kode akan digenerate otomatis saat disimpan.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="nama_supplier" name="nama_supplier" required
                                value="{{ old('nama_supplier') }}" placeholder="Contoh: PT Asa Abadi"
                        ...
                        <div>
                            ...
                            <input type="text" id="kategori_supplier" name="kategori_supplier"
                                value="{{ old('kategori_supplier') }}" placeholder="Contoh: Bahan Bangunan, Logam"
                                class="w-full bg-gray-50 border text-gray-900 text-sm rounded-lg p-2.5
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email"
                                value="{{ old('email') }}" placeholder="Contoh: supplier@mail.com"
                                class="w-full bg-gray-50 border text-gray-900 text-sm rounded-lg p-2.5
                            dark:bg-gray-700 dark:text-white border-gray-300">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="npwp" name="npwp"
                                value="{{ old('npwp') }}" placeholder="Contoh: 12.345.678.9-012.345"
                                class="w-full bg-gray-50 border text-gray-900 text-sm rounded-lg p-2.5
                            dark:bg-gray-700 dark:text-white border-gray-300">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="rekening_bank" name="rekening_bank"
                                value="{{ old('rekening_bank') }}" placeholder="Contoh: BCA / Mandiri / BRI"
                                class="w-full bg-gray-50 border text-gray-900 text-sm rounded-lg p-2.5
                            dark:bg-gray-700 dark:text-white border-gray-300">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="alamat" name="alamat" rows="3" placeholder="Alamat lengkap supplier..."
                                class="w-full bg-gray-50 border text-gray-900 text-sm rounded-lg p-2.5
                            dark:bg-gray-700 dark:text-white border-gray-300">{{ old('alamat') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
