...
<head>
    <meta charset="utf-8">
    <title>Bon Permintaan & Pengeluaran Barang - {{ $order->nomor_nbk ?? $order->nomor_order }}</title>
    <style>
...
@php
    ...
    $pengawas      = $order->pembangunanUnit?->pengawas?->nama_lengkap
                  ?? $order->pembangunanUnit?->pengawas?->name ?? '-';
    ...
    // Maksimal 8 item per setengah nota agar pas dan tidak terpotong
                    ...
                    <table class="header-wrap">
                        <tr>
                            <td style="width: 65%;">
                                ...
                                <div class="subtitle">ABM Group &mdash; Pembangunan Unit &bull; {{ $namaPerumahan }}</div>
                            </td>
