...
<head>
    <meta charset="utf-8">
    <title>Bon Permintaan & Pengeluaran Barang Kawasan - {{ $order->nomor_nbk ?? $order->nomor_order }}</title>
    <style>
                    ...
                    <table class="header-wrap">
                        <tr>
                            <td style="width: 65%;">
                                ...
                                <div class="subtitle">ABM Group &mdash; Pembangunan Kawasan &bull; {{ $namaPerumahan }}</div>
                            </td>
                        ...
                        <tbody>
                            @foreach($topSlot['items'] as $itemIdx => $item)
                                ...
                                <tr>
                                    ...
                                    <td><span class="font-bold">{{ $item->nama_barang }}</span></td>
                    ...
                    <table class="sig-table">
                        <tr>
                            <td>
                                ...
                                <div style="font-size: 7pt; color: #555;">Pengawas Kawasan</div>
