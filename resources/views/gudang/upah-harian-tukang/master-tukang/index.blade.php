            ...
            <table id="table-masterTukang">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{-- Gaji Harian Default --}}
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            Rp {{ number_format($item->gaji_harian_default, 0, ',', '.') }}
                        </td>

                        {{-- Jam Kerja Default --}}
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            {{ $item->jam_kerja_default }} Jam
                        </td>
...
<script>
    ...
    if (document.getElementById("table-masterTukang") && typeof simpleDatatables.DataTable !== 'undefined') {
        const dataTable = new simpleDatatables.DataTable("#table-masterTukang", {
            searchable: true,
            sortable: true,
