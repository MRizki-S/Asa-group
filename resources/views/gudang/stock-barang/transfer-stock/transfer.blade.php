...
<!-- ===== Main Content Start ===== -->
<div class="mx-auto max-w-[--breakpoint-2xl] p-4 md:p-6" x-data="transferStockCreate()">
    ...
    <form action="{{ route('gudang.transferStockBarang.store') }}" method="POST" @submit="validateSubmit">
                ...
                <div class="flex items-center justify-between mb-4 border-b border-gray-100 dark:border-gray-800 pb-4">
                    ...
                    <div class="flex gap-3">
                        <a href="{{ route('gudang.transferStockBarang.riwayatTransferStock') }}"
                            class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-4 focus:ring-gray-100 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700">
                            <svg class="w-4 h-4 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            Riwayat Transfer Stock
                        </a>
                        <a href="{{ route('gudang.transferStockBarang.createPenyesuaian') }}"
                ...
                <div class="flex p-4 mb-6 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" role="alert">
                    ...
                    <div>
                        ...
                        <ul class="mt-1.5 list-disc list-inside space-y-1">
                            <li>Setiap proses transfer akan secara otomatis <span class="font-bold text-red-600 dark:text-red-400 text-sm">Mengurangi Stok</span> di Gudang HUB dan <span class="font-bold text-green-600 dark:text-green-400 text-sm">Menambah Stok</span> di Gudang UBS.</li>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      cursor-not-allowed dark:bg-gray-700 dark:text-gray-400 dark:border-gray-600"
                        ...
                        <p class="mt-1 text-xs text-gray-500">Sumber stok utama (Locked)</p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-2 text-gray-700 dark:text-white">Tranfer ke Gudang <span class="text-red-500">*</span></label>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] mb-6">
            <div class="px-5 py-4 sm:px-6 sm:py-5">
                ...
                <div x-data="transferStock({{ Js::from($masterBarangs) }})" class="overflow-x-auto">
                    ...
                    <table class="w-full border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="border px-2 py-2">Stock Hub (saat ini)</th>
        ...
        return {
            ...
            initSelect2(selectEl, index) {
                ...
                $(selectEl).on('change', async (e) => {
                    ...
                    if (e.target.value) {
                        try {
                            const response = await fetch(`/gudang/transfer-stock-barang/satuan-dan-stok/${e.target.value}`);
