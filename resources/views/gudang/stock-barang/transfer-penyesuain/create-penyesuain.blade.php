...
<!-- ===== Main Content Start ===== -->
<div class="mx-auto max-w-[--breakpoint-2xl] p-4 md:p-6" x-data="penyesuaianStockCreate()">
                            ...
                            <template x-for="(item, index) in items" :key="item.ui_id">
                                <tr x-init="$nextTick(() => initSelect2($refs.barangSelect, index))">
                                    ...
                                    <td class="border p-1 text-center">
                                        <input type="number" step="any" min="0.0001" :max="item.stock_ubs_saat_ini" :name="`items[${index}][jumlah_masuk]`"
