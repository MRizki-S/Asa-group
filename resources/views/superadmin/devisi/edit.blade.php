    ...
    <div class="mx-auto max-w-[--breakpoint-2xl] p-4 md:p-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-800">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Silakan ubah nama devisi ABM GROUP.</p>
            </div>

            <form action="{{ route('superadmin.devisi.update', $devisi->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mb-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_devisi" required value="{{ old('nama_devisi', $devisi->nama_devisi) }}" 
