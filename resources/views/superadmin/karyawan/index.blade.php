        ...
        <div class="space-y-5 sm:space-y-6 mt-6">
            <div
                ...
                <div class="mb-4 flex items-center justify-between">
                    ...
                    @can('hr-management.karyawan.create')
                ...
                <form method="GET" action="{{ route('superadmin.karyawan.index') }}"
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('superadmin.karyawan.index') }}"
                            class="flex-1 sm:flex-none px-4 py-2 text-center font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition">
                            Reset
                        </a>
                    </div>
                </form>
                        ...
                        @foreach ($karyawans as $item)
                            <tr>
                                ...
                                <td class="px-6 py-4 flex flex-wrap gap-2 justify-center">
                                    @can('hr-management.karyawan.edit')
                                    ...
                                    @can('hr-management.karyawan.delete')
