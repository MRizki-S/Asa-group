...
class PengajuanPembangunanUnitController extends Controller
{
    ...
    {
        $allPengajuan = PengajuanPembangunanUnit::with([
            'perumahaan',
            'pembangunanUnit',
            ...
            'diajukanOleh',
        ])->where('perumahaan_id', $this->currentPerumahaanId())->latest()->get();

        $allPengawas = User::select('id', 'nama_lengkap')
            ->role('Pengawas Proyek')
        ...
        return view('produksi.pengajuan-pembangunan.index', [
            ...
            'breadcrumbs' => [
                ['label' => 'Pengajuan Pembangunan', 'url' => route('produksi.pengajuanPembangunanUnit.index')],
            ],
        ]);
    }
    ...
    public function create()
    {
        ...
        $allQcContainer = MasterQcContainer::select('id', 'nama_container')
            ->latest()
            ->get();

        $perumahaanId = $this->currentPerumahaanId();

        return view('Produksi.pengajuan-pembangunan.create', [
            'allPerumahaan'  => $allPerumahaan,
            'allPengawas'    => $allPengawas,
            'allQcContainer' => $allQcContainer,
            'perumahanId'    => $perumahaanId,
            'breadcrumbs'    => [
                ['label' => 'Pemngajuan Pembangunan Unit', 'url' => route('produksi.pengajuanPembangunanUnit.index')],
                ['label' => 'Tambah Pengajuan', 'url' => route('produksi.pengajuanPembangunanUnit.create')],
            ],
        ]);
    }
    ...
    public function sendGroupMessage($pembangunan)
{
    ...
    try {
        ...
        return redirect()->route('produksi.pengajuanPembangunanUnit.index')
            ->with('success', 'Data Pengajuan Pembangunan Unit berhasil ditambahkan!');
    ...
    public function edit(string $id)
    {
        ...
        return view('Produksi.pengajuan-pembangunan.edit', [
            ...
            'allQcContainer' => $allQcContainer,
            'breadcrumbs'    => [
                ['label' => 'Pengajuan Pembangunan Unit', 'url' => route('produksi.pengajuanPembangunanUnit.index')],
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('produksi.pengajuanPembangunanUnit.index')
            ->with('success', 'Data pengajuan pembangunan berhasil diperbarui!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('produksi.pengajuanPembangunanUnit.index')
            ->with('success', 'Pengajuan Pembangunan unit berhasil dihapus.');
    }
}
